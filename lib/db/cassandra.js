...
exports.completeConfirmEmail = function(secret, cb) {
  getAndDeleteRowForSecret(secret, function(err, o) {
    ...
    // new_acct is false
    // TODO worth it to check it's a v4 uuid? I think falsy check is enough for now *shrug*
    if (!o.existing_user) {
...
// TODO not sure this is the right checks that the cass server is accessible.
exports.ping = function(cb) { cb(client && (client.connected || client.connecting)) };
