...
class TestManageAccount(BaseTest):
    ...
    def _create_verified_user(self, mozwebqa):
        user = MockUser()
    ...
    def test_that_user_can_reset_password(self, mozwebqa):
        # this tests needs to be able to access the mailbox
        # which is not possible with users generated by personatestuser.org
        user = self._create_verified_user(mozwebqa)
