...
BrowserID.Mocks.xhr = (function() {
  ...
  var xhr = {
    ...
    responses: {
      ...
      "get /wsapi/have_email?email=unregistered%40gmail.com proxyidp": { email_known: false },
      ...
      "get /wsapi/address_info?email=unregistered%40gmail.com proxyidp": { type: "primary", auth: PROXY_AUTH_URL, prov: PROXY_PROV_URL },
